...
const progNav = (arrBtn: NodeListOf<Element>, carousel: HTMLElement) => {
  animate(arrBtn[currentImg].children[0], {
    width: "100%",
    duration: 3400,
    easing: "linear",
    onComplete: () => {
...
const toScrollClick = (pos: number, carousel: HTMLElement) => {
  ...
  if (currentImg != pos) {
    ...
    utils.remove(btnCar[currentImg].children[0]);
